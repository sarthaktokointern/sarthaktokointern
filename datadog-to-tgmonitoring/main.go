...
func main() {
	...
	apiKey := flag.String("api-key", "", "New Relic personal API key")
	accountID := flag.Int("account-id", IntMin, "(Optional) New Relic (sub)account ID")
	policyID := flag.Int("policy-id", IntMin, "New Relic alert policy ID")
